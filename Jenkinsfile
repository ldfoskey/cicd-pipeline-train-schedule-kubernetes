                                ...
                                sshCredentials: [
                                 ...
                                 transfers: [
                                    sshTransfer(
                                        ...
                                        "sshpass -p '$USERPASS' -v ssh -o StrictHostKeyChecking=no [54.234.169.174] $USERNAME@$control_ip \"kubectl apply -f /tmp/train-schedule-kube.yml && rm /tmp/train-schedule-kube.yml\""
                                       )
                                  ]
                              )
                           ]
