            ...
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'webserver_login', usernameVariable: 'USERNAME', passwordVariable: 'USERPASS')]) {
                 ...
                 script {
                    ...
                    sh "sshpass -p '$USERPASS' -v ssh -o StrictHostKeyChecking=no [3.95.209.80] -o UserKnownHostsFile=/dev/null $USERNAME@$control_ip \"kubectl apply -f /tmp/train-schedule-kube.yml && rm /tmp/train-schedule-kube.yml\""
                            }
                      }
                }
            }
